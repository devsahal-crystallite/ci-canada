                    ...
                    <div class="__faqsInner bg-white">
                        ...
                        $faqs = [
                            ...
                            [
                                ...
                                'content' => 'This part delves into a detailed analysis of the topic. It includes data, insights, and in-depth discussion that provides a comprehensive understanding of the subject matter.'
                            ]
                        ];
                        ?>
                            ...
                            <?php foreach ($faqs as $item): ?>
                                <div class="item p-4 flex flex-col">
                                    <div class="title font-bold d-flex justify-content-between align-items-center">
                                        <span class="text-xl"><?php echo $item['title']; ?></span>
